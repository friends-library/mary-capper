...
If I know anything of true peace, it is in simple, childlike obedience to the still,
...
And still, in this dependent, childlike state,
...
for we may feelingly adopt the language, "`This is my infirmity!`"
