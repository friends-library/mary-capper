...
The report from your dear parents is truly acceptable; the retrospect of years gone by,
...
if faithful, we should be.
We are too generally intermingled with the manners and maxims of the times.
...
`'tis the childlike hint of simple childlike love.
